    ...
    <section className="container py-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 border-b-2">
        ...
        <div className=" py-4 pb-8 px-6 pr-12">
          ...
          <p>
            <strong>Founder Partner</strong> <br />
            Mrs. Seema Bohra, founder Partner, was enrolled as a Member of ICAI in year 2000
and brings over two decades of professional experience in corporate compliance and
advisory. She specializes in ROC compliances, Secretarial Audit, and corporate legal
services. With strong expertise in regulatory frameworks, she provides strategic
guidance to ensure statutory compliance and sound corporate governance.
          </p>
        </div>
      </div>
    </section>
